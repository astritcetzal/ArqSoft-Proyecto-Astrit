...
Estoy construyendo "Magic Library", un sistema desarrollado en C# y .NET Core para que los lectores administren sus libros leídos, en proceso y pendientes. Además, el sistema permitirá establecer metas diarias, agregar notas personales, hacer seguimientos del progreso y, a futuro, recibir recomendaciones generadas por inteligencia Artificial.
